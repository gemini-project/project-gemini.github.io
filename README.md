...
Welcome! We are very pleased you want to contribute to the documentation and/or website for Gemini.
...
Clone our site
	...
	git clone https://github.com/gemini-project/gemini.github.io.git
...
To include a file that is hosted in the external, main Gemini repo, make sure it's added to [/update-imported-docs.sh](https://github.com/gemini-project/gemini.github.io/blob/master/update-imported-docs.sh), and run it so that the file gets downloaded, then enter:

<pre>&#123;% include code.html language="&lt;LEXERVALUE&gt;" file="&lt;RELATIVEPATH&gt;" gemlink="&lt;PATHFROMK8SROOT&gt;" %&#125;</pre>

* `PATHFROMK8SROOT`: The path to the file relative to the root of [the Gemini repo](https://github.com/gemini-project/gemini/tree/release-1.2), e.g. `/examples/rbd/foo.yaml`
...
* `page.githubbranch`: The name of the GitHub branch on the Gemini repo that is associated with this branch of the docs. e.g. `release-1.2`
* `page.version` The version of Gemini associated with this branch of the docs. e.g. `v1.2`
...
This keeps the docs you're editing aligned with the Gemini version you're talking about. For example, if you define a link like so, you'll never have to worry about it going stale in future doc branches:

<pre>View the README [here](http://releases.gem.io/&#123;&#123;page.githubbranch&#125;&#125;/cluster/addons/README.md).</pre>

That, of course, will send users to:

[http://releases.gem.io/release-1.2/cluster/addons/README.md](http://releases.gem.io/release-1.2/cluster/addons/README.md)

(Or whatever Gemini release that docs branch is associated with.)

## Branch structure

The current version of the website is served out of the `master` branch.

All versions of the site that relate to past and future versions will be named after their Gemini release number. For example, [the old branch for the 1.1 docs is called `release-1.1`](https://github.com/gemini-project/gemini.github.io/tree/release-1.1).

## Thank you!

Gemini thrives on community participation and we really appreciate your
