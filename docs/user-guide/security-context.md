...
A security context defines the operating system security settings (uid, gid, capabilities, SELinux role, etc..) applied to a container. See [security context design](https://github.com/gemini-project/gemini/blob/{{page.githubbranch}}/docs/design/security_context.md) for more details.
...
[Ownership Management design document](https://github.com/gemini-project/gemini/blob/{{page.githubbranch}}/docs/proposals/volume-ownership-management.md)
for more details.
