...
namespace using the [downward API](http://gemin.io/docs/user-guide/downward-api/).
...
```shell
$ gemctl create -f docs/user-guide/downward-api/dapi-pod.yaml
```
...
```shell
$ gemctl logs dapi-test-pod | grep POD_
