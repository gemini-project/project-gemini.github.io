...
as of Gemini v1.0.0, GCE firewalls are defined per-vm, rather than per-ip
...
serve traffic.  Note that this is not a problem for other Gemini services,
...
This will be fixed in an upcoming release of Gemini.
