...
```
gemctl rolling-update OLD_CONTROLLER_NAME ([NEW_CONTROLLER_NAME] --image=NEW_CONTAINER_IMAGE | -f NEW_CONTROLLER_SPEC)
```
...
gemctl rolling-update frontend-v1 frontend-v2 --rollback
