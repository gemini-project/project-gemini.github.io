...
```
gemctl port-forward POD [LOCAL_PORT:]REMOTE_PORT [...[LOCAL_PORT_N:]REMOTE_PORT_N]
```
...
gemctl port-forward mypod 5000 6000

# Listen on port 8888 locally, forwarding to 5000 in the pod
gemctl port-forward mypod 8888:5000

# Listen on a random port locally, forwarding to 5000 in the pod
gemctl port-forward mypod :5000

# Listen on a random port locally, forwarding to 5000 in the pod
gemctl port-forward  mypod 0:5000
```
