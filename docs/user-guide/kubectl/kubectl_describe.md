...
$ gemctl describe TYPE NAME_PREFIX
...
```
gemctl describe (-f FILENAME | TYPE [NAME_PREFIX | -l label] | TYPE/NAME)
```
...
```
# Describe a node
gemctl describe nodes gemini-minion-emt8.c.myproject.internal

# Describe a pod
gemctl describe pods/nginx

# Describe a pod identified by type and name in "pod.json"
gemctl describe -f pod.json

# Describe all pods
gemctl describe pods

# Describe pods by label name=myLabel
gemctl describe po -l name=myLabel

# Describe all pods managed by the 'frontend' replication controller (rc-created pods
# get the name of the rc as a prefix in the pod the name).
gemctl describe pods frontend
```
