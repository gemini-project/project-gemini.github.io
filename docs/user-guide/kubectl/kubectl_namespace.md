...
SUPERSEDED: Set and view the current Gemini namespace

### Synopsis


SUPERSEDED:  Set and view the current Gemini namespace scope for command line requests.

namespace has been superseded by the context.namespace field of .gemconfig files.  See 'gemctl config set-context --help' for more details.


```
gemctl namespace [namespace]
```
