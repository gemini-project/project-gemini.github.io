...
command line tools. It will open the editor defined by your GEM_EDITOR, or EDITOR
...
```
gemctl edit (RESOURCE/NAME | -f FILENAME)
```
...
```
  ...
  gemctl edit svc/docker-registry

  # Use an alternative editor
  GEM_EDITOR="nano" gemctl edit svc/docker-registry

  # Edit the service 'docker-registry' in JSON using the v1 API format:
  gemctl edit svc/docker-registry --output-version=v1 -o json
```
