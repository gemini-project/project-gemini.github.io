...
The Gemini scheduler is a policy-rich, topology-aware,
...
```
      ...
      --gem-api-burst=100: Burst to use while talking with gemini apiserver
      --gem-api-qps=50: QPS to use while talking with gemini apiserver
      ...
      --scheduler-name="default-scheduler": Name of the scheduler, used to select which pods will be processed by this scheduler, based on pod's annotation with key 'scheduler.alpha.gemin.io/name'
```
