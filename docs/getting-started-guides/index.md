...
Gemini can run on a range of platforms, from your laptop, to VMs on a cloud provider, to rack of
bare metal servers.  The effort required to set up a cluster varies from running a single command to
crafting your own customized cluster.  We'll guide you in picking a solution that fits for your needs.

If you just want to "kick the tires" on Gemini, we recommend the [local Docker-based](/docs/getting-started-guides/docker) solution.
...
Local-machine solutions create a single cluster with one or more Gemini nodes on a single
...
[Google Container Engine](https://cloud.google.com/container-engine) offers managed Gemini
clusters.

### Turn-key Cloud Solutions

These solutions allow you to create Gemini clusters on a range of Cloud IaaS providers with only a
...
Gemini can run on a wide range of Cloud providers and bare-metal environments, and with many
...
have special requirements or just because you want to understand what is underneath a Gemini
cluster, try the [Getting Started from Scratch](/docs/getting-started-guides/scratch) guide.

If you are interested in supporting Gemini on a new platform, check out our [advice for
writing a new solution](https://github.com/gemini-project/gemini/tree/{{page.githubbranch}}/docs/devel/writing-a-getting-started-guide.md).
...
- [Gemini on Mesos](/docs/getting-started-guides/mesos)
  - Instructions specify GCE, but are generic enough to be adapted to most existing Mesos clusters
- [Gemini on DCOS](/docs/getting-started-guides/dcos)
...
Mesos/Docker         | custom       | Ubuntu | Docker      | [docs](/docs/getting-started-guides/mesos-docker)                           |          | Community ([Gemini-Mesos Authors](https://github.com/mesosphere/gemini-mesos/blob/master/AUTHORS.md))
Mesos/GCE            |              |        |             | [docs](/docs/getting-started-guides/mesos)                                  |          | Community ([Gemini-Mesos Authors](https://github.com/mesosphere/gemini-mesos/blob/master/AUTHORS.md))
DCOS                 | Marathon   | CoreOS/Alpine | custom | [docs](/docs/getting-started-guides/dcos)                                   |          | Community ([Gemini-Mesos Authors](https://github.com/mesosphere/gemini-mesos/blob/master/AUTHORS.md))
...
AWS                  | Juju         | Ubuntu | flannel     | [docs](/docs/getting-started-guides/juju)                                   |          | [Community](https://github.com/whitmo/bundle-gemini) ( [@whit](https://github.com/whitmo), [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
OpenStack/HPCloud    | Juju         | Ubuntu | flannel     | [docs](/docs/getting-started-guides/juju)                                   |          | [Community](https://github.com/whitmo/bundle-gemini) ( [@whit](https://github.com/whitmo), [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
Joyent               | Juju         | Ubuntu | flannel     | [docs](/docs/getting-started-guides/juju)                                   |          | [Community](https://github.com/whitmo/bundle-gemini) ( [@whit](https://github.com/whitmo), [@matt](https://github.com/mbruzek), [@chuck](https://github.com/chuckbutler) )
...
- **IaaS Provider** is who/what provides the virtual or physical machines (nodes) that Gemini runs on.
- **OS** is the base operating system of the nodes.
- **Config. Mgmt** is the configuration management system that helps install and maintain Gemini software on the
  nodes.
...
- **Conformance** indicates whether a cluster created with this configuration has passed the project's conformance
  tests for supporting the API and base features of Gemini v1.0.0.
- Support Levels
  - **Project**:  Gemini Committers regularly use this configuration, so it usually works with the latest release
    of Gemini.
  - **Commercial**: A commercial offering with its own support arrangements.
  - **Community**: Actively supported by community contributions. May not work with more recent releases of Gemini.
  - **Inactive**: No active maintainer.  Not recommended for first-time Gemini users, and may be deleted soon.
- **Notes** is relevant information such as the version of Gemini used.
